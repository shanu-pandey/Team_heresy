...
#define ORIGINAL_FILE_NAME "UE4Editor-CastleOfPerdition.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME CastleOfPerdition
#define DEPRECATED_FORGAME DEPRECATED
#define CASTLEOFPERDITION_API DLLEXPORT
